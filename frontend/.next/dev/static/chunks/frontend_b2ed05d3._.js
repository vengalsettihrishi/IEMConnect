...
function RegisterForm() {
        ...
        "RegisterForm.useEffect": ()=>{
            if (isSuccess) {
                const timer = setTimeout({
                    "RegisterForm.useEffect.timer": ()=>{
                        router.push("/login");
                    }
                }["RegisterForm.useEffect.timer"], 3000);
                return ({
    ...
    const handleSubmit = async (e)=>{
        ...
        setError("");
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/auth/register", {
                name,
                email,
                password,
...
//# sourceMappingURL=frontend_b2ed05d3._.js.map